...
def main(): 
    ...
    st.markdown(' - Intro - Modul Pendul: Forløb til dem der aldrig har arbejdet med ML før med udgangspunkt i det simple pendul. Udelukkende introduktion til regression med det neurale netværk. \n'\
        ' - Standard: Til dem der har basal viden indenfor ML. Forløbet er mere matematisk og går mere i dybden med de bagvedliggende koncepter. Fire datasæt tilbydes med afsæt i forskellige problemstillinger fra hverdagen/fysikken. Introduktion til både regression og classification med det neurale netværk og boosted decision trees. Vejledningen til "Huspriser" indeholder en meget detaljeret introduktion til decision trees.\n'\
