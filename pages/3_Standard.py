...
def main():
    ...
    # Add description
    st.write('Hvis du allerede har basal viden inden for Machine Learning er dette et godt sted at starte. ' \
    'Siden indeholder en mere dybdegående introduktion til Machine Learning præsenteret i kontekst af datasæt med hhv. huspriser, diabetes, gletsjerdybder og partikler. ' \
    'Brug vejledningen (som findes i venstre siden) parallelt med denne side. ')
